...
const BREAKDOWN_ROWS: BreakdownRow[] = [
  {
    callType: 'Diamond & Gold Pricing Inquiries',
    weeklyMissed: '12-15',
    monthlyImpact: '$8,900 - $13,400',
  },
  {
    callType: 'Custom Jewelry & Engagement Rings',
    weeklyMissed: '7-9',
    monthlyImpact: '$6,100 - $8,000',
  },
  {
    callType: 'Appointment & Viewing Requests',
    weeklyMissed: '5-6',
    monthlyImpact: '$2,700 - $3,800',
  },
];
      ...
      <div className="fixed top-0 left-0 right-0 z-40 border-b border-white/10 bg-black/90 backdrop-blur-xl">
        <div className="mx-auto flex w-full max-w-7xl flex-col gap-3 px-4 py-3 md:px-8">
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div className="flex min-w-0 items-center gap-3">
              ...
              <div className="min-w-0">
                ...
                <p className="truncate text-base font-semibold tracking-tight text-white md:text-lg">{AUDITED.name}</p>
                <p className="truncate text-xs text-slate-400">{AUDITED.location}</p>
              </div>
            </div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <HeaderMetaItem tone="silver" label={`${AUDITED.name} • ${AUDITED.location}`} />
      ...
      <div className="mx-auto w-full max-w-7xl px-4 pt-52 sm:pt-48 md:px-8 md:pt-40">
          ...
          <div className="relative z-10 grid gap-8 lg:grid-cols-[1.05fr_0.95fr]">
            <div>
              ...
              <div className="mt-4 flex flex-wrap items-center gap-3 rounded-2xl border border-white/10 bg-black/40 px-4 py-3 shadow-inner">
                ...
                <span className="text-sm text-slate-400">142 Google reviews</span>
              </div>
              ...
              <div className="mt-7 grid gap-3 sm:grid-cols-3">
                <HeroMetricPill label="Inbound Calls / Week" value="38-46" />
                <HeroMetricPill label="Typical Answer Rate" value="34-39%" />
                <HeroMetricPill label="Likely Missed / Week" value="24-29 calls" />
              </div>
        ...
        <section className="mt-8 rounded-[2rem] border border-white/10 bg-white/[0.03] p-6 shadow-[0_10px_50px_rgba(0,0,0,0.45)] md:p-8">
          ...
          <p className="mt-3 max-w-4xl text-sm leading-relaxed text-white/85">
            This report is based on your Google Business Profile performance (142 reviews), website traffic patterns
            for luxury jewelry retailers, local search behavior in your area, and industry benchmarks for high-end
        ...
        <section className="mt-8">
          ...
          <div className="mt-4 grid gap-4 md:grid-cols-3">
            <KpiCard title="Estimated Inbound Calls" value="38-46 per week" />
            <KpiCard title="Typical Answer Rate" value="34-39%" />
            <KpiCard title="Likely Missed Calls" value="24-29 per week" />
          </div>
        ...
        <section className="mt-10 rounded-[2rem] border border-white/10 bg-white/[0.03] p-6 md:p-8">
          ...
          <div className="mt-5 space-y-5">
            <ProgressMetric label="Answer rate" value="98-100%" widthClass="w-[99%]" />
            <ProgressMetric label="Monthly revenue recovered" value="$17,300 - $23,600" widthClass="w-[82%]" />
            <ProgressMetric label="Typical payback period" value="42-58 days" widthClass="w-[68%]" />
          </div>
          <SectionTrustFooter />
        </section>
        ...
        <section className="mt-10 overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.03] md:grid md:grid-cols-[1fr_minmax(0,380px)] md:gap-0">
          <div className="p-6 md:p-8">
            <h2 className="text-xl font-semibold text-slate-100">Recommended Recovery Plan</h2>
            <p className="mt-3 max-w-2xl text-sm leading-relaxed text-white/75">
              Our AI Jewelry Concierge will answer every call 24/7, quote live Nivoda prices in real-time, qualify
              buyers, and book appointments directly into your calendar.
            </p>
            <SectionTrustFooter />
          </div>
          <div className="border-t border-white/10 bg-black/50 md:border-l md:border-t-0">
            <img src={nivodaGif} alt="Live Nivoda inventory intelligence" className="h-full min-h-[200px] w-full object-cover" />
          </div>
        </section>
