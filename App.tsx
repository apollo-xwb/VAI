...
const App: React.FC = () => {
    ...
    <div className="animate-in fade-in duration-1000 pb-32">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center text-center px-6 py-12 md:py-24 overflow-hidden bg-transparent transition-colors">
        <div className="relative z-10 max-w-6xl mx-auto flex flex-col items-center">
          ...
          <div className="mb-16 flex flex-col gap-3 w-full max-w-xs mx-auto">
            <button 
              onClick={() => setShowTester(true)}
              className="w-full py-5 bg-white dark:bg-navy-900 border-2 border-navy-900 dark:border-white text-navy-900 dark:text-white rounded-full font-bold text-sm uppercase tracking-widest hover:bg-navy-900 dark:hover:bg-white hover:text-white dark:hover:text-navy-950 transition-all shadow-xl flex items-center justify-center gap-2"
            >
      ...
      {/* Problem Step - Moved below Hero */}
      <section ref={problemRef} className="py-32 px-6 bg-navy-950 text-white relative overflow-hidden border-y border-white/5">
      ...
      {/* Demo Video Section - Moved and Renamed */}
      <section id="demo" className="py-32 px-6 bg-transparent">
        <div className="max-w-6xl mx-auto flex flex-col items-center">
          ...
          <div className="relative w-full max-w-4xl aspect-video rounded-[3rem] overflow-hidden shadow-[0_40px_100px_-20px_rgba(0,0,0,0.3)] group">
             <img src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&q=80&w=1500" className="w-full h-full object-cover brightness-50 group-hover:scale-105 transition-transform duration-1000" />
      ...
      <section className="py-32 px-6 bg-transparent transition-colors border-y border-navy-50 dark:border-navy-900">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-20">
          ...
          <div className="flex-1 relative animate-in slide-in-from-right duration-1000">
            <div className="absolute -inset-10 bg-navy-900/5 blur-3xl pointer-events-none rounded-full" />
            <img 
              src="https://images.unsplash.com/photo-1576426863848-c23f53cbb2b0?auto=format&fit=crop&q=80&w=1200" 
              alt="High-end showroom interaction" 
              className="rounded-[3rem] shadow-2xl border border-white/20 relative z-10 brightness-90 hover:brightness-100 transition-all duration-700"
            />
          </div>
        </div>
      </section>
      ...
      <section className="py-32 px-6 bg-transparent transition-colors">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-24 relative overflow-hidden rounded-[4rem] shadow-2xl border border-navy-50 dark:border-navy-900">
            <img 
              src="https://images.unsplash.com/photo-1551288049-bbbda5366392?auto=format&fit=crop&q=80&w=2400" 
              className="w-full h-[600px] object-cover brightness-75 hover:scale-105 transition-transform duration-[3000ms]" 
              alt="Connected digital ecosystem" 
            />
            <div className="absolute inset-0 bg-gradient-to-t from-navy-950/80 via-transparent to-transparent flex items-end p-16">
      ...
      {/* Solutions / Features */}
      <section className="py-32 px-6 bg-transparent transition-colors relative">
        <div className="max-w-5xl mx-auto text-center relative z-10">
          <h2 className="text-5xl md:text-8xl font-bold serif text-navy-900 dark:text-white mb-16 tracking-tighter">Boutique Intelligence</h2>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="p-12 rounded-[2.5rem] bg-white/80 dark:bg-navy-900/80 backdrop-blur-md border border-navy-100 dark:border-navy-800 hover:shadow-2xl transition-all group shadow-sm">
  ...
  const BlogPage = () => (
    <div className="pt-24 pb-48 px-6 max-w-6xl mx-auto animate-in fade-in duration-700 bg-transparent">
  ...
  return (
    <div className="relative min-h-screen flex flex-col bg-white dark:bg-navy-950 transition-colors overflow-x-hidden">
      ...
      {/* Persistent Footer Banner - Dotted Surface */}
      <div className="relative w-full h-[300px] pointer-events-none overflow-hidden mt-10 z-20">
        <div className="absolute inset-0 bg-gradient-to-b from-white dark:from-navy-950 via-white/10 dark:via-navy-950/10 to-transparent z-10" />
        <DottedSurface isDarkMode={isDarkMode} isProminent className="opacity-100" />
      </div>
    </div>
  );
};
